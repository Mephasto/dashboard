...
}}j.css("height",r);k.data("current",o.first);if(o.items<m){if(o.arrows){k.find(".krakatoa-control").append('<div class="arrows"><a class="arrow arrow-left" data-direction="-1" href="#">&laquo;</a><a class="arrow arrow-right" data-direction="1" href="#">&raquo;</a></div>');
